...
const rangeSlider1_min = 0;
const rangeSlider1_max = 100;

document.querySelector('#RangeSlider1 .range-slider-val-left').style.width = `${rangeSlider1_min + (100 - rangeSlider1_max)}%`;
document.querySelector('#RangeSlider1 .range-slider-val-right').style.width = `${rangeSlider1_min + (100 - rangeSlider1_max)}%`;

document.querySelector('#RangeSlider1 .range-slider-val-range').style.left = `${rangeSlider1_min}%`;
document.querySelector('#RangeSlider1 .range-slider-val-range').style.right = `${(100 - rangeSlider1_max)}%`;

document.querySelector('#RangeSlider1 .range-slider-handle-left').style.left = `${rangeSlider1_min}%`;
document.querySelector('#RangeSlider1 .range-slider-handle-right').style.left = `${rangeSlider1_max}%`;

document.querySelector('#RangeSlider1 .range-slider-tooltip-left').style.left = `${rangeSlider1_min}%`;
document.querySelector('#RangeSlider1 .range-slider-tooltip-right').style.left = `${rangeSlider1_max}%`;

document.querySelector('#RangeSlider1 .range-slider-tooltip-left .range-slider-tooltip-text').innerText = rangeSlider1_min;
document.querySelector('#RangeSlider1 .range-slider-tooltip-right .range-slider-tooltip-text').innerText = rangeSlider1_max;

document.querySelector('#RangeSlider1 .range-slider-input-left').value = rangeSlider1_min;
document.querySelector('#RangeSlider1 .range-slider-input-left').addEventListener('input', e => {
	e.target.value = Math.min(e.target.value, e.target.parentNode.childNodes[5].value - 1);
	var value = (100 / (parseInt(e.target.max) - parseInt(e.target.min))) * parseInt(e.target.value) - (100 / (parseInt(e.target.max) - parseInt(e.target.min))) * parseInt(e.target.min);
...
document.querySelector('#RangeSlider1 .range-slider-input-right').value = rangeSlider1_max;
document.querySelector('#RangeSlider1 .range-slider-input-right').addEventListener('input', e => {
	e.target.value = Math.max(e.target.value, e.target.parentNode.childNodes[3].value - (-1));
	var value = (100 / (parseInt(e.target.max) - parseInt(e.target.min))) * parseInt(e.target.value) - (100 / (parseInt(e.target.max) - parseInt(e.target.min))) * parseInt(e.target.min);
